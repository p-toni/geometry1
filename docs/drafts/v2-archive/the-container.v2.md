...
[audio|Air-to-ground · 102:42:17]
*The alarm called, and answered. Fifteen seconds.* `/audio/a11-1202-alarm.opus`
...
[audio|Air-to-ground · 102:45:40]
*Touchdown, and the answer from Houston. Fourteen seconds.* `/audio/a11-touchdown.opus`
...
The move I have never made is the one Apollo made first. Make the not-vital list while empty. Every cut I have made was made under load, by the worst available version of me, and I chose badly most of the time — I have protected the readout and dropped the steering more than once.
...
The wall was never the problem. Eight is eight — it was eight before the descent started, it was eight in every machine ever built to that spec, and no amount of wanting made a ninth core set exist at seven hundred and seventy feet.

Apollo's list was finished before the rocket left the pad.
