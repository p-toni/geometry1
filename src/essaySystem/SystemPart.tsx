...
const SWATCHES = [
  ...
  { name: 'accent', hex: '#0066aa', bordered: false },
];
...
/** Listing 1 — keywords azure, comments faint, everything else ink. No third colour. */
  ...
  return (
    <>
      ...
      <section id="s-ink" className="esys-sec">
        ...
        <p className="esys-p esys-p--lede">
          Warm paper, warm black, one azure accent. The accent is a pin, not a palette — it marks the
  ...
  return (
    <section id="s-figures" className="esys-sec esys-sec--wide">
      ...
      <p className="esys-p esys-p--lede">
        ...
        is mono-labelled, and exactly one mark per figure may be azure.
      </p>
      ...
      <div className="esys-listing">
        ...
        <div className="esys-cap">
          ...
          Syntax colour is the accent and the faint grey only: keywords azure, comments faint,
