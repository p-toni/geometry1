...
/** Listing 1 — keywords phthalo, comments faint, everything else ink. No third colour. */
  ...
  return (
    <>
      ...
      <section id="s-ink" className="esys-sec">
        ...
        <p className="esys-p esys-p--lede">
          Warm paper, warm black, one phthalo-green accent. The accent is a pin, not a palette — it marks the
  ...
  return (
    <section id="s-figures" className="esys-sec esys-sec--wide">
      ...
      <p className="esys-p esys-p--lede">
        ...
        is mono-labelled, and exactly one mark per figure may be phthalo.
      </p>
      ...
      <div className="esys-listing">
        ...
        <div className="esys-cap">
          ...
          Syntax colour is the accent and the faint grey only: keywords phthalo, comments faint,
